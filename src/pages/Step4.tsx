...
export default function Step4({ nextStep }: { nextStep: () => void }) {
  return (
    <div className="text-center flex-1 pb-20 flex justify-center items-center flex-col w-full">
      ...
      <FormButton nextStep={nextStep} text="Minimalista e delicada" icon="🎀" />
      <FormButton nextStep={nextStep} text="Coloridas e modernas" icon="🎉" />
      <FormButton nextStep={nextStep} text="Com pedras naturais" icon="💎" />
    </div>
  );
}
